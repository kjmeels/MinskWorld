...
class ApartmentFactory(DjangoModelFactory):
    ...
    price = factory.Faker("pydecimal", left_digits=12, right_digits=2, positive=True)
    original_price = factory.Faker("pydecimal", left_digits=12, right_digits=2, positive=True)
